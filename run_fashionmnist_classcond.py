...
#
#It reproduces the FashionMNIST classconditional example from Section 4.
...
def gen_i():
    ...
    ut.save_image(x_classes,f'{img_path}/FashionMNIST_classconditional.png',rows=N)
    exit()
...
if __name__ == '__main__':
    dataset = 'FMNIST'
    img_path = 'FashionMNIST_classconditional'
